...
const EditIssue = () => {
  ...
  const getdata = async () => {
    const res = await fetch(`/api/getSpecificIssuedBookRequest/${id}`, {
      method: "GET",
      headers: {
  ...
  const onFormSubmit = async (formData) => {
    setDisable(true);
    const { dateOfRequisition, dateOfIssue, dateOfReturn, quantity, price } =
      formData;

    const res2 = await fetch(`/api/updateSpecificIssuedBookRequest/${id}`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const deleteRequest = async (id) => {
    setDisable(true);
    const res2 = await fetch(`/api/deleteBookIssueRequest/${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
      ...
      <div className="card-div">
        <div className="edit-form">
          ...
          <div className="item-details">
            ...
            <h6>
              Title -{">"} {data.bookName} ({data.yearOfPublication})
            </h6>
            <h6>
              ...
              <div className="mb-3 col-lg-6 col-md-6 col-12">
                ...
                <input
                  ...
                  className={`form-control ${
                    errors.dateOfRequisition ? "is-invalid" : ""
                  }`}
              ...
              {data.dateOfReturn ? (
                <div className="mb-3 col-lg-6 col-md-6 col-12">
                  ...
                  <input
                    type="date"
                    className={`form-control ${
                      errors.dateOfReturn ? "is-invalid" : ""
                    }`}
                    id="dateOfReturn"
